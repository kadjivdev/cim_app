                    ...
                    <div class="card card-secondary">
                        ...
                        <form method="POST" action="{{ route('newclient.update', ['client' => $client->id]) }}"
                            ...
                            <div class="card-body">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="type_client_id" id=""
                                                ...
                                                <option value="{{ $typeclient->id }}"
                                                    {{ $client->type_client_id == $typeclient->id ? 'selected' : '' }}>
                                                    {{ $typeclient->libelle }}
                                                </option>
                                                @endforeach
                                            </select>
                                    ...
                                    <div class="col-6">
                                        <div class="form-group">
                                            ...
                                            <input type="number" id="ifu"
                                                ...
                                                value="{{ $client->ifu }}" autocomplete="off"
                                                autofocus>
                                            @error('ifu')
                                            <span class="text-danger">{{ $message }}</span>
                                            @enderror
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="departement_id" id=""
                                                ...
                                                <option value="{{ $departement->id }}"
                                                    {{ $client->departement_id == $departement->id ? 'selected' : '' }}>
                                                    {{ $departement->libelle }}
                                                </option>
                                                @endforeach
                                            </select>
                                ...
                                <div class="row">
                                    <div class="col-md-12">
                                        <a target="_blank" href="{{$client->bordereau_receit}}" class=""><i class="bi bi-eye"></i> Visualiser</a>
                                        <div class="form-group">
                                            <label>Bordereau de reçu <span class="text-danger">*</span></label>
                                            <input type="file" name="bordereau_receit" class="form-control">
