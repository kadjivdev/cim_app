            ...
            <div class="row">
                <div class="col-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <!-- Bon en preparation -->
                            <h5 class="">Bon en préparation</h5>
                            <table id="_example1" class="table table-bordered table-striped table-sm" style="font-size: 12px">
                                ...
                                <tbody class="table-body">
                                    ...
                                    @forelse($pre_boncommandes as $boncommande)
                                    <?php
                                    ...
                                    @empty
                                    <p class="text-center">Aucune commande en attente de validation!</p>
                                    @endforelse
                                </tbody>
...
<script>
    $(function() {
        ...
        }).buttons().container().appendTo('#_example1_wrapper .col-md-6:eq(0)');
    });
</script>
