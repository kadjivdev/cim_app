...
class Client extends Model
{
    ...
    {
        return $this->commandeclients()->count() == 0 && !$this->debit_old && $this->created_at < "2024-12-31" && !in_array($this->id, [1518,1435,1669,728,890,2482,1559,2150,643,1409,958,1317]) ;
    }
}
